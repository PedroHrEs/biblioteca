package com.atividade.biblioteca.resources.exceptions;

import com.atividade.biblioteca.service.exceptions.DataIntegrityViolationException;
import com.atividade.biblioteca.service.exceptions.ObjetctNotFoundException;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> handleMethodArgumentNotValidException(MethodArgumentNotValidException ex, HttpServletRequest request){
        ...
        ValidationError errors = new ValidationError(System.currentTimeMillis(),HttpStatus.BAD_REQUEST.value(), "Data Integrity Violation",
